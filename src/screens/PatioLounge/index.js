...
import { PlayArea, GAmeDropDown } from '../../components';
// import andicationimg from '../../assests/andicationimg.png';
...
const PatioLounge = ({ navigation, route }) => {
  ...
  const Gotodropscreen = async (val, param) => {
    ...
    //   axios(config)
    //     .then(function (response) {
    //       console.log('firstfirstfirstfirstfirstfirstfirstfirstfirstfirstfirstfirstfirstfirstfirst22222222222')
