...
import usersbylocation, { getLocationUser } from '../../services/utilities/api/auth';
  ...
  return (
    <LinearGradient
      ...
      <View style={styles.container}>
        ...
        {/* <Text style={{ alignSelf: 'center', justifyContent: 'center', color: 'white', fontSize: totalSize(2.2) }} >Loading...</Text> */}
...
{Platform.OS === 'ios' ? (
  ...
  <View
    ...
    <View
      style={{ width: deviceWidth * 0.5, height: deviceHeight * 0.14 }}>
      <Image style={{ width: '100%', height: '100%' }} source={Vlogo} />
    </View>
    <TouchableOpacity style={{ alignSelf: 'flex-start', position: 'absolute', right: 0, top: 0 }} onPress={() => navigation.navigate('contacts')} >
      <View
